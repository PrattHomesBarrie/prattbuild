<h2>Unsigned Offers</h2>
<?php

require_once ("classes/misc_functions.php");

function unsignedOffersHeader() {
	echo '  <tr>';
...
and
exists
(select 1 from offers o where o.lotNumber = odv.lotNumber and o.siteShortName = odv.siteShortName
