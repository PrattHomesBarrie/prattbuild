...
//		  if ($filterOfferStatusGroup == 'With Offers'  or ($securityLevelOneCheck != true )) { echo ' bgcolor="#FFFFCC" ';} 
		  echo '><label>
            <input  type="radio" name="filterOfferStatusGroup" value="With Offers" id="filterOfferStatusGroup_1" ';
			if ($filterOfferStatusGroup == 'With Offers' or ($securityLevelOneCheck != true ) or !isset($filterOfferStatusGroup)) { echo ' checked="checked" ';} 
          echo ' />
