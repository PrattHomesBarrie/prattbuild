...
<? echo ' - Site: <b>'.$_GET["siteName"].'</b> - Lot: <b>'.$_GET["lotNumber"].'</b>';?>
...
if ($db2->Query($query)) { 
	while ($resultRow = $db2->Row() ) {
		echo '<tr>';
		echo '<td class="lotLinkCellInTable" ><a href="index.php?myAction=Deficiency&lotNumber='.$resultRow->lotNumber.'&siteShortName='.$resultRow->siteShortName.'">';
...
<tbody>
	...
	<tr>
		...
		<td align="center">
			<a title="Upload Pictures" href="#"><img  src="./images/pic_upload_icon.png" /></a>
